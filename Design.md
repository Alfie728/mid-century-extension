...
- [~] Storage layer: define IndexedDB stores for sessions, actions, screenshots, videoChunks, uploadJobs; implement atomic writes, size tracking, eviction/quota enforcement, and cleanup routines. (Stores defined; sessions/actions persisted with eviction; screenshot/video/upload writes and quotas pending wiring.)
